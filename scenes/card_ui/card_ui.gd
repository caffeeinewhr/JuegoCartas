...
func _set_playable(value: bool) -> void:
	playable = value
	if not playable:
		card_visuals.cost.add_theme_color_override("font_color", Color.INDIAN_RED)
...
#esta funcion es para evitar que al desabilitar las cartas, quites la que estás arrastrando
